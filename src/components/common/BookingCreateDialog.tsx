...
interface BookingCreateDialogProps {
    ...
    onClose: () => void;
    onChange: (value: BookingCreateForm) => void;
    onSubmit: (event: React.FormEvent) => void;
    rooms: any[];
    bookings: any[];
}

export default function BookingCreateDialog({ open, value, onClose, onChange, onSubmit, rooms, bookings }: BookingCreateDialogProps) {
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
            ...
            <DialogContent dividers>
                ...
                <Box component="form" id="booking-create-form" onSubmit={onSubmit}>
                    <Stack spacing={2}>
            ...
            <DialogActions>
                ...
                <Button type="submit" form="booking-create-form" variant="contained">
                    Create
                </Button>
            </DialogActions>
        </Dialog>
